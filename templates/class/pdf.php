...
class PDF extends FPDF{
	...
	function result_prohibiciones($info_pdf_pr, $cab_pdf, $val_fon, $fecha_fonds, $id_ent){
		...
		$y = 60;
		$cab_pdf = 'Prohibiciones y Conflictos de Interés Para: '.$cab_pdf;
	...
	*/
		...
		// NOMBRE DEL EMISOR
			...
			$this->SetXY(10, $y);
			$this->Cell(1);
			$this->MultiCell(86, 12, (iconv('UTF-8', 'windows-1252', utf8_encode($info_pdf_emi_inv[$i][0]))), 0 , 1);
		...
		// VALOR VPN
			...
			$this->Rect(112, $y, 37, 12, 'F');
			$this->SetXY(112, $y);
			$this->Cell(1);
			$this->MultiCell(36, 12, (iconv('UTF-8', 'windows-1252', utf8_encode($info_pdf_emi_inv[$i][2]))), 0 , 1);
			
		// PARTICIPACIÓN 
			
			$this->Rect(149, $y, 24, 12, 'F');
			$this->SetXY(149, $y);
			$this->Cell(1);
			$this->MultiCell(23, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_emi_inv[$i][3].' %')), 0 , 1);
			
		// CALIFICACIÓN
			
			$this->Rect(173, $y, 30, 12, 'F');
			$this->SetXY(173, $y);
			$this->Cell(1);
			$this->MultiCell(29, 12, (iconv('UTF-8', 'windows-1252', utf8_encode($info_pdf_emi_inv[$i][4]))), 0 , 1);
	...
	*/
		...
		$cab_pdf = 'Composición del Portafolio de Depósitos por Emisor';
		...
		// VALOR VPN
			...
			$this->SetXY(112, $y);
			$this->Cell(1);
			$this->MultiCell(36, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_emi_dep[$i][2])), 0 , 1);
		...
		// PARTICIPACIÓN 
			...
			$this->SetXY(149, $y);
			$this->Cell(1);
			$this->MultiCell(23, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_emi_dep[$i][3].' %')), 0 , 1);
	...
	function result_grpeco($info_pdf_grpeco_inv, $info_pdf_grpeco_dep, $info_pdf_grpeco_tot, $id_ent){
	
	/*-> GRUPOS ECONOMICOS POR INVERSIONES */
	
		$this->SetFillColor(155, 4, 39);
		$y = 60;
		
		$cab_pdf = 'Composición Grupos Económicos por Inversión';
		...
		//print_r($info_pdf_grpeco_inv[0][0]);
		
		for($i = 0; $i<count($info_pdf_grpeco_inv); ++$i){		
		...
		// NOMBRE DEL GRUPO ECONOMICO
			...
			$this->SetXY(10, $y);
			$this->Cell(1);
			$this->MultiCell(86, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_inv[$i][0])), 0 , 1);
			
		// MAXIMO DEL GRUPO ECONOMICO
			
			$this->Rect(97, $y, 15, 12, 'F');
			$this->SetXY(97, $y);
			$this->Cell(1);
			$this->MultiCell(14, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_inv[$i][1])), 0 , 1);
		...
		// VPN 
			...
			$this->SetXY(112, $y);
			$this->Cell(1);
			$this->MultiCell(36, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_inv[$i][3])), 0 , 1);
		...
		// PARTICIPACIÓN
			...
			$this->SetXY(149, $y);
			$this->Cell(1);
			$this->MultiCell(23, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_inv[$i][2])), 0 , 1);
			
		// CALIFICACIÓN
			
			$this->Rect(173, $y, 20, 12, 'F');
			$this->SetXY(173, $y);
			$this->Cell(1);
			$this->MultiCell(19, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_inv[$i][4])), 0 , 1);
	...
	/*/**//*-> GRUPOS ECONOMICOS POR DEPOSITOS */
		
		$this->SetFillColor(155, 4, 39);
		$y = 60;
		
		$cab_pdf = 'Composición Grupos Económicos por Depósitos';
		...
		for($i = 0; $i<count($info_pdf_grpeco_dep); ++$i){
		...
		// NOMBRE DEL GRUPO ECONOMICO
			...
			$this->SetXY(10, $y);
			$this->Cell(1);
			$this->MultiCell(86, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_dep[$i][0])), 0 , 1);
		...
		// MAXIMO DEL GRUPO ECONOMICO
			...
			$this->SetXY(97, $y);
			$this->Cell(1);
			$this->MultiCell(14, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_dep[$i][1])), 0 , 1);
		...
		// VPN 
			...
			$this->SetXY(112, $y);
			$this->Cell(1);
			$this->MultiCell(36, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_dep[$i][3])), 0 , 1);
			
		// PARTICIPACIÓN
			
			$this->Rect(149, $y, 25, 12, 'F');
			$this->SetXY(149, $y);
			$this->Cell(1);
			$this->MultiCell(24, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_dep[$i][2])), 0 , 1);	
		...
		// CALIFICACIÓN
			...
			$this->SetXY(173, $y);
			$this->Cell(1);
			$this->MultiCell(19, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_dep[$i][4])), 0 , 1);
	...
	/*/**//*-> GRUPOS ECONOMICOS POR TOTALES */
		
		$this->SetFillColor(155, 4, 39);
		$y = 60;
		
		$cab_pdf = 'Composición Grupos Económicos por Total Activos';
		...
		for($i = 0; $i<count($info_pdf_grpeco_tot); ++$i){
		...
		// NOMBRE DEL GRUPO ECONOMICO
			...
			$this->SetXY(10, $y);
			$this->Cell(1);
			$this->MultiCell(86, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_tot[$i][0])), 0 , 1);
		...
		// MAXIMO DEL GRUPO ECONOMICO
			...
			$this->SetXY(97, $y);
			$this->Cell(1);
			$this->MultiCell(14, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_tot[$i][1])), 0 , 1);
		...
		// VPN 
			...
			$this->SetXY(112, $y);
			$this->Cell(1);
			$this->MultiCell(36, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_tot[$i][3])), 0 , 1);
		...
		// PARTICIPACIÓN
			...
			$this->SetXY(149, $y);
			$this->Cell(1);
			$this->MultiCell(24, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_tot[$i][2])), 0 , 1);
		
		// CALIFICACIÓN
			
			$this->Rect(174, $y, 20, 12, 'F');
			$this->SetXY(174, $y);
			$this->Cell(1);
			$this->MultiCell(19, 12, (iconv('UTF-8', 'windows-1252', $info_pdf_grpeco_tot[$i][4])), 0 , 1);
	...
	function contenido($info_pdf, $info_pdf_pr, $cab_pdf, $info_pdf_emi_inv, $info_pdf_emi_dep, $val_fon, $fecha_fonds,	$id_ent, $info_pdf_grpeco_inv, $info_pdf_grpeco_dep, $info_pdf_grpeco_tot){
			...
			$this->result_grpeco($info_pdf_grpeco_inv, $info_pdf_grpeco_dep, $info_pdf_grpeco_tot, $id_ent);
...
$info_pdf_grpeco_inv = $pdf -> array_recibe($_POST['info_pdf_grpeco_inv']);
$info_pdf_grpeco_dep = $pdf -> array_recibe($_POST['info_pdf_grpeco_dep']);
$info_pdf_grpeco_tot = $pdf -> array_recibe($_POST['info_pdf_grpeco_tot']);
...
$pdf->contenido($info_pdf, $info_pdf_pr, $cab_pdf, $info_pdf_emi_inv, $info_pdf_emi_dep, $val_fon, $fecha_fonds, $id_ent, $info_pdf_grpeco_inv, $info_pdf_grpeco_dep, $info_pdf_grpeco_tot);
