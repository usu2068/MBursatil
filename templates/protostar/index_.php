                    ...
                    <div class="col-md-4">
                        <div class="home-devices">
							<?php 
								...
								$result_dec = mysql_query($sql_dec, $link)or die('Error:'.mysql_error());
							...
							<?php while($row_dec = mysql_fetch_array($result_dec)){ ?>
						...
						<?php 
							$sql_pub = "SELECT * 
										...
										WHERE 
											`catid` = 9 
										ORDER BY `jo33_FIC_content`.`ordering` ASC";
							$result_pub = mysql_query($sql_pub, $link)or die('Error:'.mysql_error());
